...
- Create an agent that will:
   ...
   - Use the Bentley Product URL's assigned to your Group (documents/SAMPLE - BENTLEY AI WORKSHOP.xlsx) for the URL's to use for each group), as a knowledge sources for your agent.
